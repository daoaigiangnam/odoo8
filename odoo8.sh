...
cd /tmp && wget https://bitbucket.org/wkhtmltopdf/wkhtmltopdf/downloads/wkhtmltox-0.13.0-alpha-7b36694_linux-trusty-amd64.deb && sudo gdebi -n wkhtmltox-0.13.0-alpha-7b36694_linux-trusty-amd64.deb && rm wkhtmltox-0.13.0-alpha-7b36694_linux-trusty-amd64.deb
